...
@tf.function
def calculate_ab_rotation_02_tf(z_moment_raw, target_order_2_norm_rotate):
    ind_real = tf.constant(2)
    ...
    coef4 = (4 * f22_re * k_im * (-1 + k_im2 - 3 * k_re2) - 4 * f22_im * k_re * (1 - 3 * k_im2 + k_re2)
             ...
             + f21_im * (1 - 6 * k_im2 + tf.math.square(k_im2) - tf.math.square(k_re2)))
